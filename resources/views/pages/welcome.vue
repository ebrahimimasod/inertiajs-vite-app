    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-zinc-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    >
                        ...
                        <a href="https://envoyer.io" class="underline">Envoyer</a> help you take your projects to the
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                ...
                <Link href="/example" class='button w-60 h-16 bg-blue-500 rounded-lg cursor-pointer select-none
